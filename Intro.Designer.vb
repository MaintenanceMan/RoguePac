...
Partial Class Intro
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "Move by using the keypad with Numlock on:"
        '
        'Label2
        '
        ...
        Me.Label4.Location = New System.Drawing.Point(101, 77)
        ...
        Me.Label5.Text = "Eat power pellets to kill ghosts easily."
        '
        'Label6
        '
        ...
        Me.Label6.Text = "Win the game by making t to level 10."
        '
        'Button1
        '
